...
echo -e "============================" | lolcat
echo -e $b "80. Install HakkuFramework${endc}";
echo -e "============================" | lolcat
echo -e $b "81. Install HunnerFramework${endc}";
echo -e "============================" | lolcat
...
echo -e "============================" | lolcat
echo -e $b "310. Install Gmail-Hack${endc}";
echo -e "============================" | lolcat
...
sleep 0.9
echo -e "▂-[Pilih Nomer Tools Yang Ingin Di Install!]"
sleep 0.10
...
sleep 0.8
sleep 0.8
printf "\e[1;31m[+] \e[0m\e[1;67mDone!"
sleep 0.8
sleep 0.5
...
printf "                                               \e[1;31m    \e[0m\n"
sleep 0.5
printf "\e[1;67m      ____             ___   _       \e[0m\e[1;31m \e[0m\n"
sleep 0.5
printf "\e[1;67m     |  _ \ ___  ___  / _ \ | |      \e[0m\e[1;31m\e[0m\n"
sleep 0.5
printf "\e[1;67m     | |_) / _ \/ _ \| | | || |     \e[0m\e[1;31m    \e[0m\n"
sleep 0.5
printf "\e[1;67m     |  _ < |_||||_||| |_| || |____   \e[0m\e[1;31m     \e[0m\n"
sleep 0.5
printf "\e[1;67m     |_| \_\| ||||__/ \__\ \ \_____|      \e[0m\e[1;31m      \e[0m\n"
sleep 0.5 
printf "\e[1;67m                ||  \E[31mv.1.0.0\e[0m   \e[1;31m \e[0m\n"
printf "                                                   \e[1;33m \e[0m\n"
sleep 0.6 
echo ""
echo ""                                               
...
echo "" 
echo "    ==[ Tools Name : RapQL "
sleep 0.7
echo "    ==[ Build By : ♦RaMzAlf"
sleep 0.7
echo "    ==[ Version : 1.0.0"
sleep 0.7
echo "" 
...
echo -e "${bl}.";
echo -e "╭─[Pilih Nomer Nya!]${bu}"
read -p "   ⌐root@./RapQL $ " pil;
echo "[*] Tekan [y/n] Untuk Menginstal ' $pil '! "
read -p "   $ " ;
...
echo -e "\n"
    ...
    while((i<100)); do
        n=$((i*barlength / 100))
        printf "\e[00;33m\r[%-${barlength}s] \e[00;37mInstal 〓 \e[00m" "${bar:0:n}"
        ((i += RANDOM%5+2))
        sleep 0.2
    done
# Nmap
...
312) git clone https://github.com/thelinuxchoice/locator
echo -e "${y} SUDAH TERINSTALL.."

;;

00) echo "AUTHOR: RAMZALF" | lolcat
echo "RAMZALF ON YOUR SYSTEM" | lolcat
...
*) echo "[ERROR] Var '$pil' Not Avaible! "
sleep 0.10
sleep 5
esac
done
